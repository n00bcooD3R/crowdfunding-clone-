    ...
    <Link to={'/projects/' + project.id}>
      ...
      <div className='p-4'>
        ...
        <div className='w-full bg-gray-300 overflow-hidden'>
          <div className='bg-green-600 text-xs font-medium text-green-100 text-center p-0.5 leading-none rounde-l-full h-1 overflow-hidden max-w-full' style={{width: `${(project.raised / project.cost) * 100}%`}}></div>
        </div>
